function theta = train_svm(trainXC, trainY, C, maxNumIterations)
  
  if nargin  == 4 && ~isempty(maxNumIterations)
  ...
  w = minFunc(@my_l2svmloss, w0, ...
            struct('MaxIter', MAX_ITER, 'MaxFunEvals', MAX_FUN_EVALS), ...
